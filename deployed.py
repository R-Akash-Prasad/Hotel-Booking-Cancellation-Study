...
wkd_lambda = (lambda x: 0 if x=='Mon' else
              ...
              4 if x=='Fri' else
              5 if x=='Sat' else 6)
awkd = wkd_lambda(st.selectbox('Select your weekday of arrival',['Mon','Tue','Wed','Thus','Fri','Sat','Sun']))
dwkd = wkd_lambda(st.selectbox('Select your weekday of departure',['Mon','Tue','Wed','Thus','Fri','Sat','Sun']))
